...
\begin{cventries}
    \cventry
        ...
        $|$ 
        \href{https://github.com/DVLab-NTU/qsyn}{\faGithub} 190+ \raisebox{0.1em}{\textbf{$\star$}}} % Organization
        ...
        {2022 Fall--Now} % Date(s)
        {
          \begin{cvitems} % Description(s) of tasks/responsibilities
            ...
            \item Guided new team members on their contributions and taught them good coding practices
          \end{cvitems}
        }
